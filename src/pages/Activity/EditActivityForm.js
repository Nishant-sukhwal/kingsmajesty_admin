...
import { activityUpdateApi, createActivityApi, getActivitiesApi, getActivityByIdAPI } from '../../services/api/activitiesApi';
...
const EditActivityForm = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setFormData(res.data.activityById);
        }
        fetchData();
    }, [id]);
    ...
    const handleSubmit = async () => {
        try {
            const res = await activityUpdateApi(formData, id);
                        ...
                        <Row>
                            <Col key="maxchildren" lg="6">
                                <NumberInput
                                    ...
                                    onChange={handleFieldChange}
                                    defaultVal={formData.maxchildren}
                                />
                            </Col>
                        ...
                        <Row>
                            ...
                            <Col key="price_per_person" lg="6">
                                <NumberInput
                                    ...
                                    onChange={handleFieldChange}
                                    defaultVal={formData.price_per_person}
                                />
                            </Col>
                        </Row>
                        ...
                        <Row>
                            ...
                            <Col key="duration_unit" lg="6">
                                <TextInput
                                    ...
                                    onChange={handleFieldChange}
                                    defaultVal={formData.duration_unit}
                                />
                            </Col>
                        </Row>
                        ...
                        <Row>
                            ...
                            <Col key="release" lg="6">
                                <RadioButton
                                    ...
                                    defaultVal={formData.release} // defaultVal={formData.mandatory}
                                />
                            </Col>
                        </Row>
                        ...
                        <Row>
                            <Col key="hotels" lg="6">
                                <SelectInput
                                    ...
                                    options={options}
                                    onChange={handleFieldChange}
                                    errorMessage="Please Select priceType"
